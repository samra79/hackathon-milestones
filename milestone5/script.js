...
form.addEventListener('submit', function (event) { return __awaiter(_this, void 0, void 0, function () {
    var username, name, email, phone, education, experience, skills, profilePictureInput, profilePictureURL, resumeHTML, shareableURL;
    return __generator(this, function (_a) {
        ...
        resumeHTML = "\n        <h2>Editable & Shareable Resume</h2>\n                ".concat(profilePictureURL ? "<img src=\"".concat(profilePictureURL, "\" alt=\"Profile Picture\" width=\"100\" height=\"100\"><br>") : '', "\n\n        <h3>Personal Information</h3>\n        <p><strong>Name:</strong> ").concat(name, "</p>\n        <p><strong>Email:</strong> ").concat(email, "</p>\n        <p><strong>Phone:</strong> ").concat(phone, "</p>\n        <p><strong>Education:</strong> ").concat(education, "</p>\n        <p><strong>Experience:</strong> ").concat(experience, "</p>\n        <p><strong>Skills:</strong> ").concat(skills, "</p>\n    ");
